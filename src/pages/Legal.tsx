...
const CONTENT: Record<string, { h1: string; intro: string; sections: { h2: string; body: string }[] }> = {
  pt: {
    ...
    sections: [
      ...
      { h2: '8. Experiência e credenciais', body: 'A Genuíno Investments tem mais de 10 anos de atividade no desenvolvimento e gestão de projetos imobiliários premium em Lisboa, Algarve, Cascais e Genebra. A nossa equipa integra arquitetos, engenheiros, juristas e mediadores credenciados, com track record verificável em www.genuinoinvestments.ch/portfolio.' },
      { h2: '9. Garantias e seguros', body: 'Mantemos seguros de responsabilidade civil profissional ativos nos dois países e cumprimos integralmente os requisitos de capital, conduta e prevenção de branqueamento de capitais (LBC-FT) impostos pela legislação suíça (LBA) e portuguesa (Lei n.º 83/2017).' },
      { h2: '10. Acessibilidade', body: 'Procuramos cumprir as diretrizes WCAG 2.1 AA. Se encontrar barreiras de acessibilidade no site, contacte-nos para correção imediata através de info@genuinoinvestments.ch.' },
      { h2: '11. Termos comerciais', body: 'Comissões de mediação, condições de reserva, sinais e prazos de execução são definidos individualmente em proposta escrita assinada pelo cliente. Nenhuma obrigação contratual nasce do simples contacto através do site.' },
  ...
  en: {
    ...
    sections: [
      ...
      { h2: '8. Experience and credentials', body: 'Genuíno Investments has more than 10 years of activity developing and managing premium real estate projects in Lisbon, Algarve, Cascais and Geneva. Our team includes accredited architects, engineers, lawyers and brokers, with a verifiable track record at www.genuinoinvestments.ch/portfolio.' },
      { h2: '9. Guarantees and insurance', body: 'We maintain active professional liability insurance in both countries and fully comply with capital, conduct and anti-money laundering requirements imposed by Swiss law (AMLA) and Portuguese law (Law no. 83/2017).' },
      { h2: '10. Accessibility', body: 'We aim to comply with WCAG 2.1 AA. If you encounter accessibility barriers, please contact info@genuinoinvestments.ch for immediate correction.' },
      { h2: '11. Commercial terms', body: 'Brokerage fees, reservation conditions, deposits and execution deadlines are agreed individually in a written proposal signed by the client. No contractual obligation arises from simple website contact.' },
  ...
  fr: {
    ...
    sections: [
      ...
      { h2: '8. Expérience et accréditations', body: 'Genuíno Investments compte plus de 10 ans d\'activité dans le développement et la gestion de projets immobiliers premium à Lisbonne, en Algarve, à Cascais et à Genève. Notre équipe regroupe architectes, ingénieurs, juristes et courtiers accrédités, avec un parcours vérifiable sur www.genuinoinvestments.ch/portfolio.' },
      { h2: '9. Garanties et assurances', body: 'Nous maintenons des assurances responsabilité civile professionnelle actives dans les deux pays et respectons pleinement les exigences de capital, de conduite et de lutte contre le blanchiment imposées par le droit suisse (LBA) et portugais (Loi nº 83/2017).' },
      { h2: '10. Accessibilité', body: 'Nous visons la conformité WCAG 2.1 AA. Si vous rencontrez des obstacles d\'accessibilité, contactez info@genuinoinvestments.ch pour correction immédiate.' },
      { h2: '11. Conditions commerciales', body: 'Les commissions, conditions de réservation, acomptes et délais sont convenus individuellement dans une proposition écrite signée par le client. Aucune obligation contractuelle ne naît du simple contact via le site.' },
  ...
  de: {
    ...
    sections: [
      ...
      { h2: '8. Erfahrung und Qualifikationen', body: 'Genuíno Investments verfügt über mehr als 10 Jahre Erfahrung in der Entwicklung und Verwaltung von Premium-Immobilienprojekten in Lissabon, Algarve, Cascais und Genf. Unser Team umfasst akkreditierte Architekten, Ingenieure, Juristen und Makler mit nachprüfbarer Erfolgsbilanz auf www.genuinoinvestments.ch/portfolio.' },
      { h2: '9. Garantien und Versicherungen', body: 'Wir unterhalten in beiden Ländern aktive Berufshaftpflichtversicherungen und erfüllen vollständig die Anforderungen an Kapital, Verhalten und Geldwäscheprävention nach Schweizer (GwG) und portugiesischem Recht (Gesetz Nr. 83/2017).' },
      { h2: '10. Barrierefreiheit', body: 'Wir streben die Einhaltung von WCAG 2.1 AA an. Bei Barrieren wenden Sie sich bitte an info@genuinoinvestments.ch zur sofortigen Korrektur.' },
      { h2: '11. Geschäftsbedingungen', body: 'Maklerprovisionen, Reservierungsbedingungen, Anzahlungen und Ausführungsfristen werden individuell in einem vom Kunden unterzeichneten schriftlichen Angebot vereinbart. Aus einer einfachen Kontaktaufnahme über die Website entsteht keine vertragliche Verpflichtung.' },
